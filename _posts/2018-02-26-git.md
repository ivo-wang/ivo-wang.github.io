...
回到github上，进入 Account Settings（账户配置），左边选择SSH Keys，Add SSH Key,title随便填，粘贴在你电脑上生成的key。![github-account](http://www.runoob.com/wp-content/uploads/2014/05/github-account.jpg)
...
<pre class="prettyprint prettyprinted" style=""><span class="pln">git clone </span><span class="pun">/</span><span class="pln">path</span><span class="pun">/</span><span class="pln">to</span><span class="pun">/</span><span class="pln">repository </span></pre>
<p>
如果是远端服务器上的仓库，你的命令会是这个样子：
</p>
<pre class="prettyprint prettyprinted" style=""><span class="pln">git clone username@host</span><span class="pun">:</span><span class="str">/path/</span><span class="pln">to</span><span class="pun">/</span><span class="pln">repository</span></pre>
<h3>工作流</h3>
<p>
        ...
        </p><img src="http://www.runoob.com/wp-content/uploads/2014/05/trees.png" alt="trees" width="900" height="320" class="alignnone size-full wp-image-7512" srcset="http://www.runoob.com/wp-content/uploads/2014/05/trees.png 900w, http://www.runoob.com/wp-content/uploads/2014/05/trees-300x106.png 300w" sizes="(max-width: 900px) 100vw, 900px">
		<h3>推送改动</h3>
		<p>
...
<img src="http://www.runoob.com/wp-content/uploads/2014/05/branches.png" alt="branches" width="900" height="320" class="alignnone size-full wp-image-7510" srcset="http://www.runoob.com/wp-content/uploads/2014/05/branches.png 900w, http://www.runoob.com/wp-content/uploads/2014/05/branches-300x106.png 300w" sizes="(max-width: 900px) 100vw, 900px">
<p>
...
<p>
	...
	<p>
		...
		<h4>相关文章</h4>
		<ul>
		<li>Github 简明指南：<a href="http://rogerdudler.github.io/git-guide/index.zh.html" target="_blank">http://rogerdudler.github.io/git-guide/index.zh.html</a></li>
		<li>如何高效利用GitHub:<a href="http://www.yangzhiping.com/tech/github.html" target="_blank">http://www.yangzhiping.com/tech/github.html</a></li></ul></h3创建新仓库<>
